...
ggplot(data=diamonds.sample, mapping = aes(x = carat, y = price)) + geom_point()
...
ggplot(data=diamonds.sample, mapping = aes(x = price, y = carat)) +
  geom_point(color="blue")


# Draw a scatter plot for `diamonds.sample` of `price` by `carat`, where each
# point has an aesthetic _shape_ based on the diamond's `cut`.
ggplot(data=diamonds.sample, mapping = aes(x = price, y = carat, shape=cut)) +
  geom_point(color="blue")


# Draw a scatter plot for `diamonds.sample` of *`cut`* by `carat`, where each
# point has an aesthetic _size_ based on the diamond's *`price`*
ggplot(data=diamonds.sample, mapping = aes(x = price, y = carat, size=price)) +
  geom_point(color="blue")


# Try coloring the above plot based on the diamond's price!
ggplot(data=diamonds.sample, mapping = aes(x = price, y = carat, size=price, color=price)) +
  geom_point()
...
ggplot(data=diamonds.sample, mapping = aes(x = depth, fill = clarity)) +
  geom_histogram()
